...
/* Module Version: 5.7 */
/* D:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n PLL -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00 -type pll -fin 53.00 -fclkop 106 -fclkop_tol 0.0 -phase_cntl STATIC -lock -fb_mode 5 -fdc D:/Work/nut2nt-lattice/nuts2_framer/PLL/PLL.fdc  */
...
module PLL (CLKI, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    ...
    EHXPLLL PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKFB_t), .PHASESEL1(scuba_vlo), 
        ...
        .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB(CLKFB_t))
             /* synthesis FREQUENCY_PIN_CLKOP="106.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 106.000000
